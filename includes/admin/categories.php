...
class WP_School_Calendar_Categories {
    ...
    private function edit() {
        $category = wpsc_get_category( intval( $_REQUEST['wpsc_edit'] ) );
		?>
		<form method="post" action="<?php echo admin_url( 'edit.php?post_type=school_calendar&page=wpsc-category&wpsc_edit=' . intval( $_REQUEST['wpsc_edit'] ) ); ?>">
                                ...
                                <tr class="inactive">
                                    ...
                                    <td class="plugin-title column-name">
                                        ...
                                        <div class="row-actions">
                                            <span class="edit"><a href="<?php echo admin_url( 'edit.php?post_type=school_calendar&amp;page=wpsc-category&wpsc_edit=' . intval( $category['category_id'] ) ); ?>"><?php _e( 'Edit', 'wp-school-calendar' ); ?></a></span>
                                            <?php if ( intval( $default_category ) !== intval( $category['category_id'] ) ): ?>
                                            <span class="delete"> | <a href="<?php echo wp_nonce_url( admin_url( 'edit.php?post_type=school_calendar&page=wpsc-category&wpsc_delete=' . intval( $category['category_id'] ) ), 'category_delete-' . $category['category_id'] ); ?>"><?php _e( 'Delete', 'wp-school-calendar' ); ?></a></span> 
                                            <?php endif ?>
                                        </div>
                                    </td>
    ...
    public function process_delete_category() {
        $category_id = intval( $_GET['wpsc_delete'] );
